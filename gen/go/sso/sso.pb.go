...
type LoginRequest struct {
	...
	AppId         int32                  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` //App ID of the app the user is trying to login to
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` //Token to be used for authentication
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x5a, 0x16, 0x6d, 0x69, 0x6e, 0x6b, 0x6f, 0x76, 0x69, 0x63, 0x68, 0x2e, 0x73, 0x73, 0x6f, 0x2e,
